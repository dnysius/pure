...
if __name__ == "__main__":
     start = clock()
     flat_path = 'C:\\Users\\dionysius\\Desktop\\PURE\\may27\\FLAT\\clean'
     foc_path = 'C:\\Users\\dionysius\\Desktop\\PURE\\may27\\FOC\\clean'
     flat = Transducer(flat_path, "FLAT_9cm")
     foc = Transducer(foc_path, "FOC_9cm")
     
     folder = 'C:\\Users\\dionysius\\Desktop\\PURE\\may27'
     if not isdir(folder):
          mkdir(folder)
     ...
     plt.title('Total peak values 9 CM')
     plt.xlabel('angle (degree)')
