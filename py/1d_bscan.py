...
def ibscan(folder=SCAN_FOLDER, figsize=[14, 10], start=0, end=-1, y1=0, y2=-1):
    bscan(folder=folder, figsize=figsize, start=start, end=end, y1=y1, y2=y2)
    cmd = input('//\t')
    if cmd == 'x':
        print('Exit')
        pass
        ...
        try:
            ...
            if a2 == '':
                ...
                a2 = int(a2)
            ibscan(folder=folder, figsize=figsize, start=start, end=end, y1=a1, y2=a2)
        except ValueError:
            print("Invalid input")
    elif cmd == 'z':
        try:
            ...
            if a2 == '':
                ...
                a2 = int(a2)
            ibscan(folder=folder, figsize=figsize, start=a1, end=a2, y1=y1, y2=y2)
        except ValueError:
            print('invalid input')
    else:
        ibscan(folder=folder, figsize=figsize, start=start, end=end, y1=y1, y2=y2)
